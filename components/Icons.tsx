...
export const MailIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75c0-1.24-1.01-2.25-2.25-2.25H4.5c-1.24 0-2.25 1.01-2.25 2.25m19.5 0v9c0 1.24-1.01 2.25-2.25 2.25H4.5c-1.24 0-2.25-1.01-2.25-2.25v-9m19.5 0-9 5.25-9-5.25" />
    </svg>
);
...
export const EventIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0h18M12 12.75h.008v.008H12v-.008zm-3.002 0h.008v.008H9v-.008zm6.002 0h.008v.008h-.008v-.008zm-3.002 3h.008v.008H12v-.008zm-3 0h.008v.008H9v-.008zm6.002 0h.008v.008h-.008v-.008z" />
    </svg>
);
