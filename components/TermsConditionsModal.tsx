...
const TermsConditionsModal: React.FC<TermsConditionsModalProps> = ({ onClose, t }) => {
    return (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-50 animate-fade-in">
            <div className="bg-white dark:bg-neutral-900 rounded-xl p-8 w-full max-w-2xl relative shadow-2xl flex flex-col max-h-[90vh]">
                ...
                <h2 className="text-2xl font-bold text-text-primary dark:text-neutral-200 mb-4">{t('termsConditionsTitle')}</h2>
