...
export default function App() {
  ...
  return (
    <div className="h-full md:max-w-screen-xl mx-auto flex flex-col font-sans bg-white dark:bg-neutral-900 md:my-4 md:rounded-xl overflow-hidden md:shadow-2xl md:border border-border-color dark:border-neutral-800">
        {isAuthModalOpen && (
            <AuthModal
